...
void modificar() {
	...
	int op, o;
	cout << "Estas en el area para realizar una modificación. " << endl << endl;
	cout << "¿Que matrícula buscas? " << endl;
	cin >> op;
	int i = 0;
	while (i < cont) {
		if (al[i].matricula == op) {
			...
			cout << "Correo electronico: " << al[i].correo << endl;
			cout << "Numero de contacto: " << al[i].tel << endl;
			cout << "Direcciín: Colonia " << al[i].colonia << " ,Calle " << al[i].calle << " ,Numero " << al[i].n << endl;
			cout << "Calificaciones: " << al[i].cal1 << ", " << al[i].cal2 << ", " << al[i].cal3 << endl;
			cout << "Promedio: " << al[i].calfinal << endl;
			...
			case 5:
				...
				break;
			case 6:
				cout << "¿Cual de los tres campos de la dirección quieres modificar? " << endl;
				cout << "1. Colonia \n2.Calle \n3.Numero ";
				cin >> o;
				switch (o) {
				case 1:
			...
			case 7:
				...
				case 2:
					cin.ignore();
					cout << "Ingresa la nueva Calificación 2: ";
					cin >> al[cont].cal2;
					al[i].calfinal = ((al[i].cal1 * .30) + (al[i].cal2 * .45) + (al[i].cal3 * .25) / 3);
					break;
				case 3:
			...
			if (op != 0) {
				...
				cout << "Correo electronico: " << al[i].correo << endl;
				cout << "Numero de contacto: " << al[i].tel << endl;
				cout << "Dirección: Colonia " << al[i].colonia << " ,Calle " << al[i].calle << " ,Número " << al[i].n << endl;
				cout << "Calificaciones: " << al[i].cal1 << ", " << al[i].cal2 << ", " << al[i].cal3 << endl;
				cout << "Promedio: " << al[i].calfinal << endl;
			}
			else {
